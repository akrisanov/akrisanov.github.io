...
[В предыдущем посте](/2021/03/27/jira-workflow) я рассказывал как выглядит
...
![Очередь работ](/assets/images/tasks.png)
...
![Story Map](/assets/images/jira-story-map.png)
...
![Быстрые фильтры](/assets/images/filters.png)
...
1. Создать новый релиз с тэгом, соответствующим Docker-образу. Префикс компонента не требуется.
   ![Создание нового релиза](/assets/images/releases.png)
...
3. Скопировать информацию о релизе из Jira и отправить в канал #releases: в списке релизов
   ...
   ![Копирование заметок о релизе](/assets/images/releases2.png)
...
- Если кажется что что-то идет не так, копните глубже и подумайте, как это можно сгладить —
  предлагайте варианты команде / менеджеру.
...
- Когда работаете над новой задачей и делаете ее оценку, сначала сделайте небольшое исследование,
  проясните непонятные моменты и выставьте оценку с учетом рисков.
- Честно подсвечивайте риски по мере их возникновения — это самое лучшее время.
